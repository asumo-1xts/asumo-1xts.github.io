...
BibLaTeXはBibTeXより新しく便利な部分もあるものの、日本語への対応状況が芳しくありません。先人が[対策パッケージ](https://github.com/kmaed/biblatex-japanese.git 'Biblatex-japanese')を残したりしていますが、残念ながら手元であまり上手く動かなかったので、半ばごり押しで以下の項目を実装します。
