...
::: code-group
<<< @/snippets/2025/06-write_hex.ps1{powershell} [write_hex.ps1 ~vscode-icons:file-type-powershell~]
<<< @/snippets/2025/06-write_hex.sh{shell} [write_hex.sh ~vscode-icons:file-type-shell~]
:::
